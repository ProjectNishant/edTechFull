<template>
<div class="pb-5 pt-5 ">
<div id="freeUseCase" class="container">
    <div class="row">
    ...
    <div class="card position-relative  bg-white programCard">
          ...
          <p class="pl-2">Summary:</p>
            <p class="position-absolute text-dark ">
                ...
                <div  orientation="vertical" class="ml-3 mb-3 pt-2">
                  <div class="row">
                    <span type="hollow" class=" dHfCyZ1 ml-1" v-on:click="openForm5(useCase.screenshots)"><i class="fa fa-photo"></i> Screenshots</span>
                    <span type="hollow" class=" dHfCyZ" v-on:click="openPreview2(useCase.videoUrl)"><i class="fa fa-play-circle"></i> Preview</span>
                    </div>
                </div>
        ...
        <div class="card-body pt-5">
          ...
          <div class="float-right pt-5 pb-2" v-if="useCase.price">
            <span type="hollow" class=" dHfCy3" v-on:click="gotoData2(useCase._id, useCase.redirectLink, useCase.price)">Enroll <i class="fa fa-sign-in"></i></span>
          </div>
          <div class="float-right pt-5 pb-2" v-if="!(useCase.price)">
    ...
    <div class="form-popup ml-3" id="myForm">
      <button class="btn btn-danger ml-2 mt-2 mb-auto float-right"  v-on:click="closeForm2">Close</button>
      <div class="row ml-1 mb-auto">
        <div class="card col-lg-3 ml-2"  v-for="imgData in info" :key="imgData._id">
              <img :src="imgData.path" width="100%" height="auto" v-on:click="openImg2(imgData.path)">
        </div>
      </div>
    </div>

    <div id="myModal" class="modal">
      <span class="close mr-5" style="cursor:pointer; color: red;" v-on:click="closeImg2">&times;</span>
      <img class="modal-content" id="img01">
    </div>

    <div class="form-popup ml-2" id="myVideo">
        <button class="btn btn-danger mb-auto float-right"  v-on:click="closePreview2">Close</button>
        <div class="row">
...
const axios = require('axios').default;
    export default {
        ...
        openForm5 : function(screenshotData) { 
